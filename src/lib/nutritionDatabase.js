...
const auVerifiedFoods = [
  ...
  { id: "coffee_piccolo_macchiato", name: "Coffee, piccolo latte / macchiato, from ground coffee beans, with regular fat cow's milk", aliases: ["piccolo", "piccolo latte", "macchiato", "short macchiato", "long macchiato"], quantity: "100ml", calories: 48, protein_g: 2.9, carbs_g: 3.5, fat_g: 2.6, category: "drink" },
  { id: "coffee_mocha", name: "Coffee, mocha, from ground coffee beans, with regular fat cow's milk and chocolate", aliases: ["mocha", "cafe mocha"], quantity: "100ml", calories: 72, protein_g: 2.8, carbs_g: 8.2, fat_g: 3.1, category: "drink" },
  { id: "coffee_iced_latte", name: "Coffee, iced latte, from ground coffee beans, with regular fat cow's milk", aliases: ["iced latte", "iced coffee latte"], quantity: "100ml", calories: 48, protein_g: 2.9, carbs_g: 3.5, fat_g: 2.6, category: "drink" },
  { id: "coffee_cold_brew", name: "Coffee, cold brew, from ground coffee beans, black", aliases: ["cold brew", "cold brew coffee", "batch brew"], quantity: "100ml", calories: 3, protein_g: 0.4, carbs_g: 0, fat_g: 0.1, category: "drink" },
  { id: "coffee_plain", name: "Coffee, brewed, from ground coffee beans, black", aliases: ["coffee", "drip coffee", "filter coffee", "brewed coffee", "plunger coffee"], quantity: "100ml", calories: 3, protein_g: 0.4, carbs_g: 0, fat_g: 0.1, category: "drink" },
  { id: "barramundi_fillet_grilled", name: "Barramundi, fillet, grilled, no added fat", aliases: ["barramundi", "barra", "grilled barramundi", "barra fillet"], quantity: "100g", calories: 93, protein_g: 20.1, carbs_g: 0, fat_g: 1.5, category: "protein" },
  { id: "chicken_parmigiana", name: "Chicken parmigiana, pub-style, with tomato sauce and mozzarella", aliases: ["chicken parma", "chicken parmi", "parma", "parmi", "chicken parmigiana", "chicken parm"], quantity: "1 serve (380g)", calories: 760, protein_g: 62, carbs_g: 28, fat_g: 42, category: "mixed meal" },
  { id: "overnight_oats", name: "Overnight oats, with milk, no toppings", aliases: ["overnight oats", "bircher muesli", "bircher"], quantity: "100g", calories: 120, protein_g: 5.2, carbs_g: 17.8, fat_g: 2.9, category: "breakfast" },
  { id: "sourdough_bread", name: "Bread, sourdough, wheat, from bakery", aliases: ["sourdough", "sourdough bread", "sourdough loaf"], quantity: "100g", calories: 274, protein_g: 9.8, carbs_g: 51.2, fat_g: 2.1, category: "carbs" },
  { id: "crumpet", name: "Crumpet, plain, toasted", aliases: ["crumpet", "crumpets"], quantity: "100g", calories: 198, protein_g: 7.4, carbs_g: 38.1, fat_g: 1.3, category: "carbs" },
  { id: "cottage_cheese", name: "Cheese, cottage, regular fat", aliases: ["cottage cheese"], quantity: "100g", calories: 103, protein_g: 11.1, carbs_g: 3.4, fat_g: 4.5, category: "dairy" },
  { id: "protein_ball", name: "Protein ball / bliss ball, oat and nut base, estimated", aliases: ["protein ball", "protein balls", "bliss ball", "bliss balls", "energy ball", "energy balls"], quantity: "1 ball (35g)", calories: 145, protein_g: 6.2, carbs_g: 12.4, fat_g: 7.8, category: "snack" },
  { id: "medjool_date", name: "Date, medjool, pitted, raw", aliases: ["medjool date", "medjool dates", "dates", "date"], quantity: "100g", calories: 277, protein_g: 1.8, carbs_g: 75, fat_g: 0.2, category: "produce" },
  { id: "rice_cake_plain", name: "Rice cake, plain, no added salt", aliases: ["rice cake", "rice cakes", "corn thin", "corn thins", "vita wheat", "vita-weat"], quantity: "100g", calories: 391, protein_g: 8.2, carbs_g: 80.1, fat_g: 3.5, category: "snack" },
  { id: "acai_bowl", name: "Acai bowl, with banana, granola, and honey, cafe-style", aliases: ["acai bowl", "acai", "acai smoothie bowl"], quantity: "1 serve (350g)", calories: 434, protein_g: 8.2, carbs_g: 72.1, fat_g: 12.6, category: "breakfast" },
  { id: "whey_protein_powder", name: "Whey protein powder, unflavoured / vanilla", aliases: ["whey protein", "protein powder", "whey protein powder", "whey", "protein supplement"], quantity: "100g", calories: 383, protein_g: 80, carbs_g: 8, fat_g: 4, category: "protein" },
