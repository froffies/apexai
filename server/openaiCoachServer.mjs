...
- When a user clarifies how an already-logged food was prepared (e.g. "half the eggs were hardboiled, the other half were fried in butter" after eggs were already logged), construct a single clean update_meal_log action with an accurate food_name like "3 hard boiled eggs and 3 eggs fried in butter". Do not concatenate the old log summary with the new description. Do not create separate items for "half" and "the other half" — resolve the proportional split into concrete quantities and produce one clean updated entry.
