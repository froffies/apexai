...
test("coach session state handles fifty varied fragmented meal conversations", () => {
  const mealTemplates = [
    {
...
test("coach session state handles thirty varied fragmented workout conversations", () => {
